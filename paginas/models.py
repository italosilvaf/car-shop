...
class HomeModels(models.Model):
    ...
    publicado_home = models.BooleanField(verbose_name="Publicado", default=False)
...
class QualidadesHomeModels(models.Model):
    ...
    publicado_qualidade = models.BooleanField(verbose_name="Publicado", default=False)
...
class SobreNosModels(models.Model):
    ...
    publicado_sobre_nos = models.BooleanField(verbose_name="Publicado", default=False)
...
class EstoqueModels(models.Model):
    ...
    publicado_estoque = models.BooleanField(verbose_name="Publicado", default=False)
