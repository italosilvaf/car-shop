...
from .models import HomeModels, QualidadesHomeModels, SobreNosModels, FuncionarioModels, EstoqueModels
from django.views.generic import View, ListView, DetailView
from carro.models import CarroModels
from categorias.models import EstadoDeConservacaoModels, CategoriaModels, CorModels, MarcaModels, CambioModels
...
class EstoqueIndex(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['personalizacoes'] = EstoqueModels.objects.filter(
            publicado_estoque=True).order_by('-id').first()
